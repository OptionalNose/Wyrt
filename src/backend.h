...
typedef struct {
	...
	WyrtRvalue (*rvalue_struct_lit)(WyrtContext, const DebugInfo*, Type, TypeContext const*, WyrtRvalue*, size_t, Error*);
	WyrtRvalue (*rvalue_array_lit)(WyrtContext, const DebugInfo*, Type, TypeContext const*, WyrtRvalue*, size_t, Error*);
	...
	WyrtRvalue (*rvalue_field)(WyrtContext, const DebugInfo*, WyrtRvalue, Type, TypeContext const *, size_t, Error*);
	WyrtRvalue (*rvalue_fn_call)(WyrtContext, const DebugInfo*, WyrtFunction, WyrtRvalue*, size_t, Error*);


	WyrtLvalue (*block_new_variable)(WyrtContext, const DebugInfo*, WyrtBlock, Type, TypeContext const *, const char*, Error*);
	WyrtLvalue (*lvalue_subscript)(WyrtContext, const DebugInfo*, WyrtRvalue, WyrtRvalue, Error*);
	WyrtLvalue (*lvalue_deref_field)(WyrtContext, const DebugInfo*, WyrtRvalue, Type, TypeContext const *, size_t, Error*);
	WyrtLvalue (*lvalue_deref)(WyrtContext, const DebugInfo*, WyrtRvalue, Error*);
	WyrtLvalue (*lvalue_field)(WyrtContext, const DebugInfo*, WyrtLvalue, Type, TypeContext const *, size_t, Error*);
